...
from wiki.views import PageDetailView, PageList
...
urlpatterns = [
    path('wiki/', PageList.as_view(), name='wiki-list-page'),
    path('w/<str:slug>/', PageDetailView.as_view(), name='wiki-details-page'),
]